...
function parseContent(data: Element): Content | Content[] | null {
...
function parseStandardInfo(data: Element): Content | null {
...
function parseSmallInfo(data: Element): Content[] | null {
